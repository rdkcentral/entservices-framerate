...
############################
# Build entservices-framerate
echo "building entservices-framerate"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-framerate \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-framerate --target install
echo "======================================================================================"
exit 0
